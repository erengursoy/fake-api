<template>
  <div>
    <api :isSelect="true" :selectClass="'border border-blue-400'" :tableClass="'divide-blue-200'" :inputClass="'border pt-10'" :endpoint="endpoint">
    ...
    <template v-slot:footer>
       <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8 text-center">
